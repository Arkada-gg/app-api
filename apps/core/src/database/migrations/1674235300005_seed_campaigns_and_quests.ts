...
export async function up(client: PoolClient): Promise<void> {
  await client.query(`
    ...
    VALUES
      ('018f0071-a409-4ec2-960b-7bdddd74d2ab', 'summer-sale', 'Summer Sale', 'Enjoy our exclusive summer discounts!', 'https://example.com/images/summer-sale.png',
        '[{"type": "tokens", "value": "100"}, {"type": "tokens", "value": "50"}]',
        '2025-01-01T00:00:00Z', '2025-06-30T23:59:59Z', 150, 'basic', NOW(), NOW()),
      
      ('${uuidv4()}', 'winter-fest', 'Winter Fest', 'Join our winter festivities and earn rewards!', 'https://example.com/images/winter-fest.png',
        '[{"type": "tokens", "value": "200"}, {"type": "tokens", "value": "75"}]',
        '2025-01-01T00:00:00Z', '2025-12-31T23:59:59Z', 300, 'premium', NOW(), NOW()),
      
      ('${uuidv4()}', 'spring-blossom', 'Spring Blossom', 'Celebrate the spring season with exciting quests!', 'https://example.com/images/spring-blossom.png',
