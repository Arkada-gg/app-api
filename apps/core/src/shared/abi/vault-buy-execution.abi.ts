export const VaultABI = [
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: 'bytes32', name: 'key', type: 'bytes32' },
      { indexed: false, internalType: 'bool', name: 'hasProfit', type: 'bool' },
      {
        indexed: false,
        internalType: 'uint256',
        name: 'delta',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bool', name: '_isLong', type: 'bool' },
      { internalType: 'uint256', name: '_lastIncreasedTime', type: 'uint256' },
    ],
    name: 'getDelta',
    outputs: [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bool', name: '_isLong', type: 'bool' },
      { internalType: 'uint256', name: '_size', type: 'uint256' },
      { internalType: 'uint256', name: '_entryFundingRate', type: 'uint256' },
    ],
    name: 'getFundingFee',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: '_averagePrice', type: 'uint256' },
      { internalType: 'uint256', name: '_nextPrice', type: 'uint256' },
      { internalType: 'uint256', name: '_nextSize', type: 'uint256' },
      { internalType: 'uint256', name: '_delta', type: 'uint256' },
      { internalType: 'int256', name: '_realisedPnl', type: 'int256' },
    ],
    name: 'getNextGlobalAveragePrice',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
  ...
  {
    inputs: [
      { internalType: 'address', name: '_errorController', type: 'address' },
    ],
