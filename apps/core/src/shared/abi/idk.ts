export const randomABI = [
  ...
  { inputs: [], name: 'EpochHasNotStartedYet', type: 'error' },
  { inputs: [], name: 'ExpectedPause', type: 'error' },
  { inputs: [], name: 'FailedInnerCall', type: 'error' },
  { inputs: [], name: 'InsufficientBalance', type: 'error' },
  { inputs: [], name: 'InvalidAddress', type: 'error' },
  { inputs: [], name: 'InvalidAmount', type: 'error' },
  { inputs: [], name: 'InvalidCommissionFee', type: 'error' },
  { inputs: [], name: 'InvalidEpoch', type: 'error' },
  { inputs: [], name: 'InvalidId', type: 'error' },
  { inputs: [], name: 'InvalidInitDate', type: 'error' },
  { inputs: [], name: 'InvalidInitialization', type: 'error' },
  { inputs: [], name: 'InvalidRound', type: 'error' },
  { inputs: [], name: 'InvalidRoundPrice', type: 'error' },
  ...
  { inputs: [], name: 'VaultCannotDeposit', type: 'error' },
  { inputs: [], name: 'VaultCannotWithdraw', type: 'error' },
  {
    anonymous: false,
    inputs: [
  ...
  },
  {
    ...
    name: 'countUnsettledFilledOrders',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'expirationEpoch', type: 'uint256' },
    ],
    name: 'depositCouponTo',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bool', name: 'skipSettlement', type: 'bool' },
    ],
    name: 'executeRound',
    outputs: [],
  ...
  {
    inputs: [
      { internalType: 'uint256[]', name: 'epochList', type: 'uint256[]' },
    ],
    name: 'fillSettlementResult',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'address', name: 'overUser', type: 'address' },
          { internalType: 'address', name: 'underUser', type: 'address' },
          { internalType: 'uint256', name: 'overPrice', type: 'uint256' },
          { internalType: 'uint256', name: 'underPrice', type: 'uint256' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_commissionfee', type: 'uint256' },
      {
        internalType: 'address',
        name: '_clearingHouseAddress',
        type: 'address',
      },
    ...
    outputs: [
      {
        ...
        internalType: 'struct ProductRound',
        name: '',
        type: 'tuple',
      },
    ],
